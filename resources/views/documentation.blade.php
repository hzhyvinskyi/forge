...
@section('content')
    <div class="col-md-12 content">
        ...
        <div class="documentation__method-item">
            <h4>Seeding</h4>
            <p>
                Используется для наполнения таблицы реальными данными.
            </p>
            <p>
                Чтобы наполнить определённую таблицу данными, нужно создать под неё класс-seeder: php artisan
                make:seeder TableNameSeeder, и там в методе run() прописать нужные данные для наполнения.
            </p>
            <p>
                php artisan db:seed - вызовет заполнение для всех таблиц. А при указании флага --class=TableNameSeeder,
                будет заполняться только выбранная таблица.
            </p>
        </div>
        <div class="documentation__method-item">
            <h4>Helpers</h4>
        ...
        <div class="documentation__method-item">
            ...
            <p>
                ...
                delete() - удалит запись<br>
                update() - обновит запись. Принимант массив с новыми данными.
            </p>
            <p>
